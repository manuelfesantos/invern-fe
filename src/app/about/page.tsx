            ...
            <div className='flex'>
              <div className="flex-1 px-12 lg:px-40 flex flex-col justify-center gap-6 mt-12">
                <div className='flex flex-col items-center'>
                  ...
                  <h3 className='hidden lg:block'>And Welcome To My Creative Space.</h3>
                  <h4 className='lg:hidden'>And Welcome To My Creative Space.</h4>
                </div>
                <hr />
                <Image src={About1} alt="" className='w-full h-24 lg:h-48 object-cover' />
                <div className='flex w-full items-center'>
                  <h3 className='hidden lg:block'>I'm so excited to be starting my online business as a ceramics artist!</h3>
                  <h4 className='lg:hidden'>I'm so excited to be starting my online business as a ceramics artist!</h4>
                </div>
                <p>
                ...
                <div className='flex flex-col lg:flex-row gap-12'>
                  <div className='flex-1'>
                    <h4>
                    In fact, my background in scenography and interior design has been incredibly influential on my ceramics.
                    </h4>
                    <Image src={About2} alt="" className='lg:hidden w-full h-[420px] object-cover'/>
                    <br />
                    <p>
                  ...
                  <Image src={About2} alt="" className='hidden lg:block w-[40%] h-[560px]  object-cover'/>
                </div>
              </div>
            </div>
          </section>
