        ...
        <form className='w-full' onSubmit={formik.handleSubmit}>
            ...
            <div className="relative w-full lg:px-6 flex justify-between">
                <div className='flex gap-2'>
                    <input type="checkbox" name="remember" id="remember" className="py-3 focus:outline-none" />
                    <label htmlFor="remember" className="">Remember me?</label>
                </div>
                <CustomLink position="text-sm lg:text-base" href=''>Forgot your password?</CustomLink>
            </div>
            ...
            <CustomButton position='w-full py-3' type='submit'>sign in</CustomButton>
            <div className="relative w-full my-4 lg:my-6 flex flex-col items-center justify-center">
                <div>
                    Not a member?
                </div>
                <div>
                    <CustomLink position="" onClick={() => setActiveTab('signup')} href=''>Create an account here</CustomLink>.
                </div>
            </div>
        </form>
    )
