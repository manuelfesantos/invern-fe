...
const CartItemsCounter = () => {
  ...
  const cartTotalQuantity = cart.products.reduce(
  ...
  return (
    cart.products.length > 0 && (
      <div
        className={`absolute -top-3 ${cartTotalQuantity > 9 ? "-right-5" : "-right-3"} h-5 w-5 flex items-center justify-center bg-primary`}
      >
