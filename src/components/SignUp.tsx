...
const SignUp = ({setActiveTab}:{setActiveTab:Dispatch<SetStateAction<string>>}) => {
    ...
    return (
        <form className='w-full' onSubmit={formik.handleSubmit}>
            ...
            <div className="w-full my-6 lg:my-10 text-center">
                Already a member? <CustomLink onClick={() => setActiveTab('signin')} href=''>Login here</CustomLink>.
            </div>
            <CustomButton position='w-full py-3' type='submit'>sign up</CustomButton>
        </form>
    )
}
