...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
        <div className="w-96 flex flex-col items-center justify-center mt-6 p-6 bg-[#4C4B48] shadow-lg drop-shadow-lg shadow-[#201F1D]">
            <div className='px-6'>
                <ul className="flex mb-6">
                    <li>
                        <h4
                            onClick={() => setActiveTab('signin')}
                            className={activeTab === 'signin' ? "cursor-pointer p-4 border-b-2" : "cursor-pointer p-4 text-[#201F1D] hover:text-blue-600"}>
                                Sign In
                        </h4>
                    </li>
                    <li>
                        <h4
                            ...
                            className={activeTab === 'signup' ? "cursor-pointer p-4 border-b-2" : "cursor-pointer p-4 text-[#201F1D] hover:text-blue-600"}>
                                Sign Up
                        </h4>
                    </li>
                </ul>
                    ...
                    activeTab === 'signin'
                        ? (
                            <form className='w-full'>
                                ...
                                <Button position='w-full py-2' onClick=''>sign in</Button>
                            </form>
                        )
                        : (
                            <form className='w-full'>
                                ...
                                <Button position='w-full py-2 mt-4' onClick=''>sign up</Button>
                            </form>
                        )
                }
            </div>
